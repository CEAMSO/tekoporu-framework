...
public class LastPageLinkRenderer extends PageLinkRenderer implements
	...
	public void render(FacesContext context, UIData uidata) throws IOException {
        ...
        this.render(context, uidata, UIData.PAGINATOR_LAST_PAGE_LINK_CLASS, UIData.PAGINATOR_LAST_PAGE_ICON_CLASS, disabled);
	}
