...
public class PrevPageLinkRenderer extends PageLinkRenderer implements
	...
	public void render(FacesContext context, UIData uidata) throws IOException {
        ...
        this.render(context, uidata, UIData.PAGINATOR_PREV_PAGE_LINK_CLASS, UIData.PAGINATOR_PREV_PAGE_ICON_CLASS, disabled);
	}
