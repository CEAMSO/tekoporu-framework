...
public class PaginatedDelegateCrud<T, I, C extends PaginatedCrud<T, I>> implements PaginatedCrud<T, I> {
	...
	public void setPaginated(boolean paginated) {
		getDelegate().setPaginated(paginated);
		
	}

	@Override
	public boolean isPaginated() {
		return getDelegate().isPaginated();
	}

	@Override
	public void setPage(int currentPage, int pageSize) {
		 getDelegate().setPage(currentPage, pageSize);
	}

	@Override
	public List<T> findAllOrderBy(String sortProperty, String sortDirection) {
		return getDelegate().findAllOrderBy(sortProperty, sortDirection);
	}
